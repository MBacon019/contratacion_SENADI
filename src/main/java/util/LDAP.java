 ...
 */
package com.example.sistema_contratacion.util;
...
//                    System.out.println("2 "+unprocessedGroupCN);
                    ...
                    if (isSame(groupCN, unprocessedGroupCN) && isSame(groupDistinguishedName, unprocessedGroupDN)) {
                        System.out.println(user + " authorized coactivas");
                        return 1;
                    } else {
...
//                System.out.println("333333");
            ...
            System.out.println(user + " not authorized coactivas");

            return -1;
        } catch (Exception ex) {
            System.out.println("Credenciales incorrectas coactivas: " + user);
            return 0;
        }
    }
...
//            System.out.println(inet.isReachable(5000) ? "Host is reachable" : "Host is NOT reachable");
            ...
            System.out.println("Error validando conexion ldap coactivas: " + ex);
        }
    }
